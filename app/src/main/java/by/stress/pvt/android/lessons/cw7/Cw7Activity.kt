...
//import kotlinx.android.synthetic.main.activity_cw7.*

//import kotlinx.android.synthetic.main.activity_cw7.*

class Cw7Activity : AppCompatActivity(), cw7ListAdapter.ClickListener {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cw7)

        val cw7_recycler = findViewById<RecyclerView>(R.id.cw7_recycler)

        //cw7_recycler.hasFixedSize()
        cw7_recycler.setHasFixedSize(true)
        cw7_recycler.layoutManager = LinearLayoutManager(this,
            LinearLayoutManager.VERTICAL, false)
        cw7_recycler.isNestedScrollingEnabled = false // если внутри другого скролла
        ...
        cw7_recycler.adapter = cw7ListAdapter(items, this )




        // cw7_recycler.addItemDecoration() // отступы-линии...
